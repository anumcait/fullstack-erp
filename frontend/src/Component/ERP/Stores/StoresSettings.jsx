...
const StoresSettings = () => {
  const settings = [
    { title: 'Warehouse Locations', desc: 'Define storage bins and areas.', icon: <FiMap /> },
    { title: 'Inventory Policy', desc: 'Set FIFO/LIFO rules.', icon: <FiSettings /> }
  ];

  return (
    <Box sx={{ p: 4 }}>
      <Typography variant="h4" sx={{ mb: 4, fontWeight: 'bold', color: '#0b3c91' }}>Stores Settings</Typography>
