...
export default function StoresApprovals() {
    ...
    return (
        <Box sx={{ p: { xs: 2, md: 3 } }}>
            <PageHeader
                title="Stores Approvals"
                subtitle="Stores inbox — material requisitions, goods receipts, and stock audits awaiting your decision"
