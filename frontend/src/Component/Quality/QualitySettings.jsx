...
const QualitySettings = () => {
  const settings = [
    { title: 'Inspection Parameters', desc: 'Define QA checkpoints.', icon: <FiCheckCircle /> },
    { title: 'Tolerance Limits', desc: 'Set acceptable error ranges.', icon: <FiSettings /> }
  ];

  return (
    <Box sx={{ p: 4 }}>
      <Typography variant="h4" sx={{ mb: 4, fontWeight: 'bold', color: 'var(--heading-color)' }}>Quality Settings</Typography>
