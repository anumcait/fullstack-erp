...
const PAGE_TITLES = [
  ...
  ['/stores/non-returnable-gate-passes', 'Non Returnable Gate Pass'],
  ['/stores/inward-registers', 'Inward Register'],
['/stores/sale-approval', 'Jobwork Billing'],
  ['/stores/invoices', 'GRR Billing'],
  ['/stores/repair-billing', 'Repair Billing'],
  ['/stores/maintenance-billing', 'Maintenance Billing'],
  ['/stores/misc-voucher-billing', 'Miscellaneous / Voucher Billing'],
  ['/stores/cancellations', 'Cancellations'],
